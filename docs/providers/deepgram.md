...
Deepgram is a speech-to-text API. In Sigil it is used for **inbound audio/voice note
transcription** via `tools.media.audio`.

When enabled, Sigil uploads the audio file to Deepgram and injects the transcript
