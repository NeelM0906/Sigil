...
You can point Sigil at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or Sigil
...
- [Anthropic provider](/providers/anthropic) - Native Sigil integration with Claude setup-token or API keys
