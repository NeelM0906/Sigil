---
summary: "Use MiniMax M2.1 in Sigil"
read_when:
  - You want MiniMax models in Sigil
...
Configure manually via `sigil.json`:
...
- Use `sigil models list` and `sigil models set minimax/MiniMax-M2.1` to switch.
...
- Running `sigil configure` and selecting **MiniMax M2.1**, or
