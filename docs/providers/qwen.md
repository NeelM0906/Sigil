---
summary: "Use Qwen OAuth (free tier) in Sigil"
read_when:
  - You want to use Qwen with Sigil
...
```bash
sigil models set qwen-portal/coder-model
```

## Reuse Qwen Code CLI login

If you already logged in with the Qwen Code CLI, Sigil will sync credentials
