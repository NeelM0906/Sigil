...
Sigil ships three update channels:
...
When you **explicitly** switch channels with `--channel`, Sigil also aligns
the install method:
...
When you switch channels with `sigil update`, Sigil also syncs plugin sources:
