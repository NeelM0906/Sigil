...
This page ties together how Sigil handles inbound messages, sessions, queueing,
...
Channels can redeliver the same message after reconnects. Sigil keeps a
...
Sigil separates the **prompt body** from the **command body**:
...
Sigil can expose or hide model reasoning:
