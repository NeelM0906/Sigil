...
Sigil has two separate “streaming” layers:
...
When block streaming is enabled, Sigil can **merge consecutive block chunks**
...
When draft streaming is active, Sigil disables block streaming for that reply to avoid double-streaming.
