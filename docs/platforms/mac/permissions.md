...
- Same path: run the app from a fixed location (for Sigil, `dist/Sigil.app`).
...
```bash
sudo tccutil reset Accessibility com.sigil.mac
sudo tccutil reset ScreenCapture com.sigil.mac
