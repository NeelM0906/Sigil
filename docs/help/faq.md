---
summary: "Frequently asked questions about Sigil setup, configuration, and usage"
---
# FAQ
...
- [Quick start and first-run setup](#quick-start-and-firstrun-setup)
  ...
  - [What’s the recommended way to install and set up Sigil?](#whats-the-recommended-way-to-install-and-set-up-sigil)
  ...
  - [I can't access docs.sigil.bot (SSL error). What now?](#i-cant-access-docssigil-ssl-error-what-now)
  - [What’s the difference between stable and beta?](#whats-the-difference-between-stable-and-beta)
- [How do I install the beta version, and what’s the difference between beta and dev?](#how-do-i-install-the-beta-version-and-whats-the-difference-between-beta-and-dev)
  - [How do I try the latest bits?](#how-do-i-try-the-latest-bits)
  - [How long does install and onboarding usually take?](#how-long-does-install-and-onboarding-usually-take)
  - [Installer stuck? How do I get more feedback?](#installer-stuck-how-do-i-get-more-feedback)
  - [Windows install says git not found or sigil not recognized](#windows-install-says-git-not-found-or-sigil-not-recognized)
  - [The docs didn’t answer my question - how do I get a better answer?](#the-docs-didnt-answer-my-question-how-do-i-get-a-better-answer)
  - [How do I install Sigil on Linux?](#how-do-i-install-sigil-on-linux)
  - [How do I install Sigil on a VPS?](#how-do-i-install-sigil-on-a-vps)
  ...
  - [If I buy a Mac mini to run Sigil, can I connect it to my MacBook Pro?](#if-i-buy-a-mac-mini-to-run-sigil-can-i-connect-it-to-my-macbook-pro)
  - [Can I use Bun?](#can-i-use-bun)
  - [Telegram: what goes in `allowFrom`?](#telegram-what-goes-in-allowfrom)
  - [Can multiple people use one WhatsApp number with different Sigils?](#can-multiple-people-use-one-whatsapp-number-with-different-sigils)
  - [Can I run a "fast chat" agent and an "Opus for coding" agent?](#can-i-run-a-fast-chat-agent-and-an-opus-for-coding-agent)
  - [Does Homebrew work on Linux?](#does-homebrew-work-on-linux)
  - [What’s the difference between the hackable (git) install and npm install?](#whats-the-difference-between-the-hackable-git-install-and-npm-install)
  - [Can I switch between npm and git installs later?](#can-i-switch-between-npm-and-git-installs-later)
  - [Should I run the Gateway on my laptop or a VPS?](#should-i-run-the-gateway-on-my-laptop-or-a-vps)
  - [How important is it to run Sigil on a dedicated machine?](#how-important-is-it-to-run-sigil-on-a-dedicated-machine)
  - [What are the minimum VPS requirements and recommended OS?](#what-are-the-minimum-vps-requirements-and-recommended-os)
  - [Can I run Sigil in a VM and what are the requirements](#can-i-run-sigil-in-a-vm-and-what-are-the-requirements)
- [What is Sigil?](#what-is-sigil)
  - [What is Sigil, in one paragraph?](#what-is-sigil-in-one-paragraph)
  - [What’s the value proposition?](#whats-the-value-proposition)
  - [I just set it up what should I do first](#i-just-set-it-up-what-should-i-do-first)
  - [What are the top five everyday use cases for Sigil](#what-are-the-top-five-everyday-use-cases-for-sigil)
  - [Can Sigil help with lead gen outreach ads and blogs for a SaaS](#can-sigil-help-with-lead-gen-outreach-ads-and-blogs-for-a-saas)
...
- [Skills and automation](#skills-and-automation)
  ...
  - [Can Sigil run tasks on a schedule or continuously in the background?](#can-sigil-run-tasks-on-a-schedule-or-continuously-in-the-background)
...
- [Where things live on disk](#where-things-live-on-disk)
  - [Is all data used with Sigil saved locally?](#is-all-data-used-with-sigil-saved-locally)
  - [Where does Sigil store its data?](#where-does-sigil-store-its-data)
  - [Where should AGENTS.md / SOUL.md / USER.md / MEMORY.md live?](#where-should-agentsmd-soulmd-usermd-memorymd-live)
  - [What’s the recommended backup strategy?](#whats-the-recommended-backup-strategy)
  - [How do I completely uninstall Sigil?](#how-do-i-completely-uninstall-sigil)
...
- [Config basics](#config-basics)
  ...
  - [Can the Sigil browser run headless?](#can-the-sigil-browser-run-headless)
...
- [Remote gateways + nodes](#remote-gateways-nodes)
  ...
  - [Can two Sigils talk to each other (local + VPS)?](#can-two-sigils-talk-to-each-other-local-vps)
...
- [Env vars and .env loading](#env-vars-and-env-loading)
  - [How does Sigil load environment variables?](#how-does-sigil-load-environment-variables)
...
- [Sessions & multiple chats](#sessions-multiple-chats)
  ...
  - [Is there a way to make a team of Sigils one CEO and many agents](#is-there-a-way-to-make-a-team-of-sigils-one-ceo-and-many-agents)
  - [Why did context get truncated mid-task? How do I prevent it?](#why-did-context-get-truncated-midtask-how-do-i-prevent-it)
  - [How do I completely reset Sigil but keep it installed?](#how-do-i-completely-reset-sigil-but-keep-it-installed)
  ...
  - [Why doesn’t Sigil reply in a group?](#why-doesnt-sigil-reply-in-a-group)
...
- [Gateway: ports, “already running”, and remote mode](#gateway-ports-already-running-and-remote-mode)
  ...
  - [Why does `sigil gateway status` say `Runtime: running` but `RPC probe: failed`?](#why-does-sigil-gateway-status-say-runtime-running-but-rpc-probe-failed)
  - [Why does `sigil gateway status` show `Config (cli)` and `Config (service)` different?](#why-does-sigil-gateway-status-show-config-cli-and-config-service-different)
  - [What does “another gateway instance is already listening” mean?](#what-does-another-gateway-instance-is-already-listening-mean)
  - [How do I run Sigil in remote mode (client connects to a Gateway elsewhere)?](#how-do-i-run-sigil-in-remote-mode-client-connects-to-a-gateway-elsewhere)
...
- [Logging and debugging](#logging-and-debugging)
  ...
  - [I closed my terminal on Windows - how do I restart Sigil?](#i-closed-my-terminal-on-windows-how-do-i-restart-sigil)
  ...
  - [ELI5: `sigil gateway restart` vs `sigil gateway`](#eli5-sigil-gateway-restart-vs-sigil-gateway)
  - [What’s the fastest way to get more details when something fails?](#whats-the-fastest-way-to-get-more-details-when-something-fails)
- [Media & attachments](#media-attachments)
  - [My skill generated an image/PDF, but nothing was sent](#my-skill-generated-an-imagepdf-but-nothing-was-sent)
- [Security and access control](#security-and-access-control)
  - [Is it safe to expose Sigil to inbound DMs?](#is-it-safe-to-expose-sigil-to-inbound-dms)
...
5) **Tail the latest log**
   ...
   ```bash
   tail -f "$(ls -t /tmp/sigil/sigil-*.log | head -1)"
   ```
...
7) **Gateway snapshot**
   ```bash
   sigil health --json
   sigil health --verbose   # shows the target URL + config path on errors
   ```
...
```bash
curl -fsSL https://sigil.bot/install.sh | bash -s -- --install-method git
```

This installs Sigil **from a git checkout**, so the agent can read the code + docs and
...
https://github.com/sigil/sigil/issues
https://github.com/sigil/sigil/pulls
...
What they do:
- `sigil status`: quick snapshot of gateway/agent health + basic config.
- `sigil models status`: checks provider auth + model availability.
- `sigil doctor`: validates and repairs common config/state issues.

Other useful CLI checks: `sigil status --all`, `sigil logs --follow`,
`sigil gateway status`, `sigil health --verbose`.

Quick debug loop: [First 60 seconds if something's broken](#first-60-seconds-if-somethings-broken).
Install docs: [Install](/install), [Installer flags](/install/installer), [Updating](/install/updating).

### Whats the recommended way to install and set up Sigil
...
```bash
git clone https://github.com/sigil/sigil.git
cd sigil
pnpm install
pnpm build
...
If you don’t have a global install yet, run it via `pnpm sigil onboard`.
...
- If it asks for auth, run `sigil dashboard` and use the tokenized link (`?token=...`).
- The token is the same value as `gateway.auth.token` (or `SIGIL_GATEWAY_TOKEN`) and is stored by the UI after first load.

**Not on localhost:**
- **Tailscale Serve** (recommended): keep bind loopback, run `sigil gateway --tailscale serve`, open `https://<magicdns>/`. If `gateway.auth.allowTailscale` is `true`, identity headers satisfy auth (no token).
- **Tailnet bind**: run `sigil gateway --bind tailnet --token "<token>"`, open `http://<tailscale-ip>:18789/`, paste token in dashboard settings.
- **SSH tunnel**: `ssh -N -L 18789:127.0.0.1:18789 user@host` then open `http://127.0.0.1:18789/?token=...` from `sigil dashboard`.
...
1) Install Sigil on the new machine.
2) Copy `$SIGIL_STATE_DIR` (default: `~/.sigil`) from the old machine.
3) Copy your workspace (default: `~/sigil`).
4) Run `sigil doctor` and restart the Gateway service.
...
under `~/.sigil/` (for example `~/.sigil/agents/<agentId>/sessions/`).

Related: [Migrating](/install/migrating), [Where things live on disk](/help/faq#where-does-sigil-store-its-data),
...
https://github.com/sigil/sigil/blob/main/CHANGELOG.md

Newest entries are at the top. If the top section is marked **Unreleased**, the next dated
section is the latest shipped version. Entries are grouped by **Highlights**, **Changes**, and
**Fixes** (plus docs/other sections when needed).

### I cant access docssigil SSL error What now

Some Comcast/Xfinity connections incorrectly block `docs.sigil.bot` via Xfinity
Advanced Security. Disable it or allowlist `docs.sigil.bot`, then retry. More
detail: [Troubleshooting](/help/troubleshooting#docssigil-shows-an-ssl-error-comcastxfinity).
Please help us unblock it by reporting here: https://spa.xfinity.com/check_url_status.

If you still can't reach the site, the docs are mirrored on GitHub:
https://github.com/sigil/sigil/tree/main/docs
...
```bash
curl -fsSL --proto '=https' --tlsv1.2 https://sigil.bot/install.sh | bash -s -- --beta
```

```bash
curl -fsSL --proto '=https' --tlsv1.2 https://sigil.bot/install.sh | bash -s -- --install-method git
```

Windows installer (PowerShell):
https://sigil.bot/install.ps1
...
```bash
curl -fsSL https://sigil.bot/install.sh | bash -s -- --verbose
```

Beta install with verbose:

```bash
curl -fsSL https://sigil.bot/install.sh | bash -s -- --beta --verbose
```

For a hackable (git) install:

```bash
curl -fsSL https://sigil.bot/install.sh | bash -s -- --install-method git --verbose
```

More options: [Installer flags](/install/installer).

### Windows install says git not found or sigil not recognized
...
**2) sigil is not recognized after install**
...
### How do I install Sigil on Linux
...
### How do I install Sigil on a VPS
...
sigil update
sigil update status
sigil update --channel stable|beta|dev
sigil update --tag <dist-tag|version>
sigil update --no-restart
```

If you must automate from an agent:

```bash
sigil update --yes --no-restart
sigil gateway restart
```
...
`sigil onboard` is the recommended setup path. In **local mode** it walks you through:
...
No. You can run Sigil with **API keys** (Anthropic/OpenAI/others) or with
...
`claude setup-token` generates a **token string** via the Claude Code CLI (it is not available in the web console). You can run it on **any machine**. Choose **Anthropic token (paste setup-token)** in the wizard or paste it with `sigil models auth paste-token --provider anthropic`. The token is stored as an auth profile for the **anthropic** provider and used like an API key (no auto-refresh). More detail: [OAuth](/concepts/oauth).
...
Copy the token it prints, then choose **Anthropic token (paste setup-token)** in the wizard. If you want to run it on the gateway host, use `sigil models auth setup-token --provider anthropic`. If you ran `claude setup-token` elsewhere, paste it on the gateway host with `sigil models auth paste-token --provider anthropic`. See [Anthropic](/providers/anthropic).

### Do you support Claude subscription auth (Claude Pro/Max)

Yes — via **setup-token**. Sigil no longer reuses Claude Code CLI OAuth tokens; use a setup-token or an Anthropic API key. Generate the token anywhere and paste it on the gateway host. See [Anthropic](/providers/anthropic) and [OAuth](/concepts/oauth).
...
Tip: set a **fallback model** so Sigil can keep replying while a provider is rate‑limited.
...
Sigil supports **OpenAI Code (Codex)** via OAuth (ChatGPT sign-in). The wizard can run the OAuth flow and will set the default model to `openai-codex/gpt-5.2` when appropriate. See [Model providers](/concepts/model-providers) and [Wizard](/start/wizard).

### Do you support OpenAI subscription auth Codex OAuth

Yes. Sigil fully supports **OpenAI Code (Codex) subscription OAuth**. The onboarding wizard
...
Gemini CLI uses a **plugin auth flow**, not a client id or secret in `sigil.json`.

Steps:
1) Enable the plugin: `sigil plugins enable google-gemini-cli-auth`
2) Login: `sigil models auth login --provider google-gemini-cli --set-default`

This stores OAuth tokens in auth profiles on the gateway host. Details: [Model providers](/concepts/model-providers).

### Is a local model OK for casual chats

Usually no. Sigil needs large context + strong safety; small cards truncate and leak. If you must, run the **largest** MiniMax M2.1 build you can locally (LM Studio) and see [/gateway/local-models](/gateway/local-models). Smaller/quantized models increase prompt-injection risk - see [Security](/gateway/security).
...
No. Sigil runs on macOS or Linux (Windows via WSL2). A Mac mini is optional - some people
...
any Mac works. Sigil’s iMessage integrations run on macOS (BlueBubbles or `imsg`), while
...
### If I buy a Mac mini to run Sigil can I connect it to my MacBook Pro
...
- Use `sigil nodes status` / `sigil nodes list` to see it.
...
- DM your bot, then run `sigil logs --follow` and read `from.id`.
...
### Can multiple people use one WhatsApp number with different Sigils
...
If you run Sigil via systemd, ensure the service PATH includes `/home/linuxbrew/.linuxbrew/bin` (or your brew prefix) so `brew`-installed tools resolve in non‑login shells.
...
This **does not delete your data** - it only changes the Sigil code install. Your state
(`~/.sigil`) and workspace (`~/sigil`) stay untouched.
...
**Sigil-specific note:** WhatsApp/Telegram/Slack/Mattermost (plugin)/Discord all work fine from a VPS. The only real trade-off is **headless browser** vs a visible window. See [Browser](/tools/browser).

**Recommended default:** VPS if you had gateway disconnects before. Local is great when you’re actively using the Mac and want local file access or UI automation with a visible browser.

### How important is it to run Sigil on a dedicated machine
...
Sigil is lightweight. For a basic Gateway + one chat channel:
...
### Can I run Sigil in a VM and what are the requirements
...
### What is Sigil in one paragraph

Sigil is a personal AI assistant you run on your own devices. It replies on the messaging surfaces you already use (WhatsApp, Telegram, Slack, Mattermost (plugin), Discord, Google Chat, Signal, iMessage, WebChat) and can also do voice + a live Canvas on supported platforms. The **Gateway** is the always-on control plane; the assistant is the product.

### Whats the value proposition

Sigil is not “just a Claude wrapper.” It’s a **local-first control plane** that lets you run a
...
### What are the top five everyday use cases for Sigil
...
### Can Sigil help with lead gen outreach ads and blogs for a SaaS
...
Sigil draft and you approve.

Docs: [Security](/gateway/security).

### What are the advantages vs Claude Code for web development

Sigil is a **personal assistant** and coordination layer, not an IDE replacement. Use
Claude Code or Codex for the fastest direct coding loop inside a repo. Use Sigil when you
...
Showcase: https://sigil.bot/showcase

## Skills and automation

### How do I customize skills without keeping the repo dirty

Use managed overrides instead of editing the repo copy. Put your changes in `~/.sigil/skills/<name>/SKILL.md` (or add a folder via `skills.load.extraDirs` in `~/.sigil/sigil.json`). Precedence is `<workspace>/skills` > `~/.sigil/skills` > bundled, so managed overrides win without touching git. Only upstream-worthy edits should live in the repo and go out as PRs.

### Can I load skills from a custom folder

Yes. Add extra directories via `skills.load.extraDirs` in `~/.sigil/sigil.json` (lowest precedence). Default precedence remains: `<workspace>/skills` → `~/.sigil/skills` → bundled → `skills.load.extraDirs`. `clawdhub` installs into `./skills` by default, which Sigil treats as `<workspace>/skills`.
...
Checklist:
- Confirm cron is enabled (`cron.enabled`) and `SIGIL_SKIP_CRON` is not set.
- Check the Gateway is running 24/7 (no sleep/restarts).
- Verify timezone settings for the job (`--tz` vs host timezone).

Debug:
```bash
sigil cron run <jobId> --force
sigil cron runs --id <jobId> --limit 50
```
...
### Can Sigil run tasks on a schedule or continuously in the background
...
Not directly. macOS skills are gated by `metadata.sigil.os` plus required binaries, and skills only appear in the system prompt when they are eligible on the **Gateway host**. On Linux, `darwin`-only skills (like `imsg`, `apple-notes`, `apple-reminders`) will not load unless you override the gating.

You have three supported patterns:

**Option A - run the Gateway on a Mac (simplest).**  
Run the Gateway where the macOS binaries exist, then connect from Linux in [remote mode](#how-do-i-run-sigil-in-remote-mode-client-connects-to-a-gateway-elsewhere) or over Tailscale. The skills load normally because the Gateway host is macOS.

**Option B - use a macOS node (no SSH).**  
Run the Gateway on Linux, pair a macOS node (menubar app), and set **Node Run Commands** to "Always Ask" or "Always Allow" on the Mac. Sigil can treat macOS-only skills as eligible when the required binaries exist on the node. The agent runs those skills via the `nodes` tool. If you choose "Always Ask", approving "Always Allow" in the prompt adds that command to the allowlist.
...
3) Override the skill metadata (workspace or `~/.sigil/skills`) to allow Linux:
   ```markdown
   ---
   name: imsg
   description: iMessage/SMS CLI for listing chats, history, watch, and sending.
   metadata: {"sigil":{"os":["darwin","linux"],"requires":{"bins":["imsg"]}}}
   ---
   ```
4) Start a new session so the skills snapshot refreshes.

For iMessage specifically, you can also point `channels.imessage.cliPath` at an SSH wrapper (Sigil only needs stdio). See [iMessage](/channels/imessage).
...
ClawdHub installs into `./skills` under your current directory (or falls back to your configured Sigil workspace); Sigil treats that as `<workspace>/skills` on the next session. For shared skills across agents, place them in `~/.sigil/skills/<name>/SKILL.md`. Some skills expect binaries installed via Homebrew; on Linux that means Linuxbrew (see the Homebrew Linux FAQ entry above). See [Skills](/tools/skills) and [ClawdHub](/tools/clawdhub).
...
```bash
sigil browser extension install
sigil browser extension path
```
...
Sigil memory is just Markdown files in the agent workspace:
- Daily notes in `memory/YYYY-MM-DD.md`
- Curated long-term notes in `MEMORY.md` (main/private sessions only)

Sigil also runs a **silent pre-compaction memory flush** to remind the model
...
If you don’t set a provider explicitly, Sigil auto-selects a provider when it
can resolve an API key (auth profiles, `models.providers.*.apiKey`, or env vars).
It prefers OpenAI if an OpenAI key resolves, otherwise Gemini if a Gemini key
resolves. If neither key is available, memory search stays disabled until you
configure it. If you have a local model path configured and present, Sigil
prefers `local`.
...
### Is all data used with Sigil saved locally

No - **Sigil’s state is local**, but **external services still see what you send them**.

- **Local by default:** sessions, memory files, config, and workspace live on the Gateway host
  (`~/.sigil` + your workspace directory).
...
### Where does Sigil store its data

Everything lives under `$SIGIL_STATE_DIR` (default: `~/.sigil`):

| Path | Purpose |
|------|---------|
| `$SIGIL_STATE_DIR/sigil.json` | Main config (JSON5) |
| `$SIGIL_STATE_DIR/credentials/oauth.json` | Legacy OAuth import (copied into auth profiles on first use) |
| `$SIGIL_STATE_DIR/agents/<agentId>/agent/auth-profiles.json` | Auth profiles (OAuth + API keys) |
| `$SIGIL_STATE_DIR/agents/<agentId>/agent/auth.json` | Runtime auth cache (managed automatically) |
| `$SIGIL_STATE_DIR/credentials/` | Provider state (e.g. `whatsapp/<accountId>/creds.json`) |
| `$SIGIL_STATE_DIR/agents/` | Per‑agent state (agentDir + sessions) |
| `$SIGIL_STATE_DIR/agents/<agentId>/sessions/` | Conversation history & state (per agent) |
| `$SIGIL_STATE_DIR/agents/<agentId>/sessions/sessions.json` | Session metadata (per agent) |

Legacy single‑agent path: `~/.sigil/agent/*` (migrated by `sigil doctor`).

Your **workspace** (AGENTS.md, memory files, skills, etc.) is separate and configured via `agents.defaults.workspace` (default: `~/sigil`).

### Where should AGENTSmd SOULmd USERmd MEMORYmd live

These files live in the **agent workspace**, not `~/.sigil`.

- **Workspace (per agent)**: `AGENTS.md`, `SOUL.md`, `IDENTITY.md`, `USER.md`,
  `MEMORY.md` (or `memory.md`), `memory/YYYY-MM-DD.md`, optional `HEARTBEAT.md`.
- **State dir (`~/.sigil`)**: config, credentials, auth profiles, sessions, logs,
  and shared skills (`~/.sigil/skills`).

Default workspace is `~/sigil`, configurable via:

```json5
{
  agents: { defaults: { workspace: "~/sigil" } }
}
```
...
Do **not** commit anything under `~/.sigil` (credentials, sessions, tokens).
If you need a full restore, back up both the workspace and the state directory
separately (see the migration question above).

Docs: [Agent workspace](/concepts/agent-workspace).

### How do I completely uninstall Sigil
...
`workspace` to the repo root. The Sigil repo is just source code; keep the
...
Sigil reads an optional **JSON5** config from `$SIGIL_CONFIG_PATH` (default: `~/.sigil/sigil.json`):

```
$SIGIL_CONFIG_PATH
```

If the file is missing, it uses safe‑ish defaults (including a default workspace of `~/sigil`).

### I set gatewaybind lan or tailnet and now nothing listens the UI says unauthorized

Non-loopback binds **require auth**. Configure `gateway.auth.mode` + `gateway.auth.token` (or use `SIGIL_GATEWAY_TOKEN`).
...
If you **really** want open loopback, remove `gateway.auth` from your config. Doctor can generate a token for you any time: `sigil doctor --generate-gateway-token`.
...
key. **Recommended:** run `sigil configure --section web` to store it in
...
- Daemons read env vars from `~/.sigil/.env` (or the service environment).
...
### Can the Sigil browser run headless
...
Check the basics:
- Gateway is running: `sigil gateway status`
- Gateway health: `sigil status`
- Channel health: `sigil channels status`
...
### Can two Sigils talk to each other local VPS
...
`sigil agent --message ... --deliver`, targeting a chat where the other bot
listens. If one bot is on a remote VPS, point your CLI at that remote Gateway
via SSH/Tailscale (see [Remote access](/gateway/remote)).

Example pattern (run from a machine that can reach the target Gateway):
```bash
sigil agent --message "Hello from local bot" --deliver --channel telegram --reply-to <chat-id>
```
...
Recover:
- Restore from backup (git or a copied `~/.sigil/sigil.json`).
- If you have no backup, re-run `sigil doctor` and reconfigure channels/models.
- If this was unexpected, file a bug and include your last known config or any backup.
- A local coding agent can often reconstruct a working config from logs or history.

Avoid it:
- Use `sigil config set` for small changes.
- Use `sigil configure` for interactive edits.
...
### How does Sigil load environment variables

Sigil reads env vars from the parent process (shell, launchd/systemd, CI, etc.) and additionally loads:

- `.env` from the current working directory
- a global fallback `.env` from `~/.sigil/.env` (aka `$SIGIL_STATE_DIR/.env`)
...
1) Put the missing keys in `~/.sigil/.env` so they’re picked up even when the service doesn’t inherit your shell env.
...
`SIGIL_LOAD_SHELL_ENV=1`, `SIGIL_SHELL_ENV_TIMEOUT_MS=15000`.

### I set COPILOTGITHUBTOKEN but models status shows Shell env off Why

`sigil models status` reports whether **shell env import** is enabled. “Shell env: off”
does **not** mean your env vars are missing - it just means Sigil won’t load
your login shell automatically.

If the Gateway runs as a service (launchd/systemd), it won’t inherit your shell
environment. Fix by doing one of these:

1) Put the token in `~/.sigil/.env`:
   ```
...
### Is there a way to make a team of Sigils one CEO and many agents
...
### How do I completely reset Sigil but keep it installed
...
```bash
sigil reset --scope full --yes --non-interactive
```
...
- If you used profiles (`--profile` / `SIGIL_PROFILE`), reset each state dir (defaults are `~/.sigil-<profile>`).
- Dev reset: `sigil gateway --dev --reset` (dev-only; wipes dev config + credentials + sessions + workspace).
...
headers like `# Heading`), Sigil skips the heartbeat run to save API calls.
...
No. Sigil runs on **your own account**, so if you’re in the group, Sigil can see it.
...
```bash
sigil directory groups list --channel whatsapp
```

Docs: [WhatsApp](/channels/whatsapp), [Directory](/cli/directory), [Logs](/cli/logs).

### Why doesnt Sigil reply in a group
...
- **Disk growth:** sessions + transcripts live under `~/.sigil/agents/<agentId>/sessions/`.
...
- Use `sigil doctor` to spot stray workspaces and profile mismatches.
...
Sigil’s default model is whatever you set as:

```
agents.defaults.model.primary
```

Models are referenced as `provider/model` (example: `anthropic/claude-opus-4-5`). If you omit the provider, Sigil currently assumes `anthropic` as a temporary deprecation fallback - but you should still **explicitly** set `provider/model`.
...
- `sigil models set ...` (updates just model config)
- `sigil configure --section models` (interactive)
- edit `agents.defaults.model` in `~/.sigil/sigil.json`

Avoid `config.apply` with a partial object unless you intend to replace the whole config.
If you did overwrite config, restore from backup or re-run `sigil doctor` to repair.
...
Yes. Sigil ships a few default shorthands (only applied when the model exists in `agents.defaults.models`):
...
```
~/.sigil/agents/<agentId>/agent/auth-profiles.json
```

Fix options:
- Run `sigil agents add <id>` and configure auth during the wizard.
...
Cooldowns apply to failing profiles (exponential backoff), so Sigil can keep responding even when a provider is rate‑limited or temporarily failing.
...
- **Confirm where auth profiles live** (new vs legacy paths)
  - Current: `~/.sigil/agents/<agentId>/agent/auth-profiles.json`
  - Legacy: `~/.sigil/agent/*` (migrated by `sigil doctor`)
- **Confirm your env var is loaded by the Gateway**
  - If you set `ANTHROPIC_API_KEY` in your shell but run the Gateway via systemd/launchd, it may not inherit it. Put it in `~/.sigil/.env` or enable `env.shellEnv`.
- **Make sure you’re editing the correct agent**
  - Multi‑agent setups mean there can be multiple `auth-profiles.json` files.
- **Sanity‑check model/auth status**
  - Use `sigil models status` to see configured models and whether providers are authenticated.
...
- **Use a setup-token**
  - Run `claude setup-token`, then paste it with `sigil models auth setup-token --provider anthropic`.
  - If the token was created on another machine, use `sigil models auth paste-token --provider anthropic`.
- **If you want to use an API key instead**
  - Put `ANTHROPIC_API_KEY` in `~/.sigil/.env` on the **gateway host**.
  - Clear any pinned order that forces a missing profile:
    ```bash
    sigil models auth order clear --provider anthropic
    ```
...
If your model config includes Google Gemini as a fallback (or you switched to a Gemini shorthand), Sigil will try it during model fallback. If you haven’t configured Google credentials, you’ll see `No API key found for provider "google"`.
...
Fix: Sigil now strips unsigned thinking blocks for Google Antigravity Claude. If it still appears, start a **new session** or set `/thinking off` for that agent.
...
Sigil uses provider‑prefixed IDs like:
...
Sigil may temporarily skip a profile if it’s in a short **cooldown** (rate limits/timeouts/auth failures) or a longer **disabled** state (billing/insufficient credits). To inspect this, run `sigil models status --json` and check `auth.unusableProfiles`. Tuning: `auth.cooldowns.billingBackoffHours*`.

You can also set a **per-agent** order override (stored in that agent’s `auth-profiles.json`) via the CLI:

```bash
# Defaults to the configured default agent (omit --agent)
sigil models auth order get --provider anthropic

# Lock rotation to a single profile (only try this one)
sigil models auth order set --provider anthropic anthropic:default

# Or set an explicit order (fallback within provider)
sigil models auth order set --provider anthropic anthropic:work anthropic:default
...
```bash
sigil models auth order set --provider anthropic --agent main anthropic:default
```
...
```
--port > SIGIL_GATEWAY_PORT > gateway.port > default 18789
```

### Why does sigil gateway status say Runtime running but RPC probe failed

Because “running” is the **supervisor’s** view (launchd/systemd/schtasks). The RPC probe is the CLI actually connecting to the gateway WebSocket and calling `status`.

Use `sigil gateway status` and trust these lines:
- `Probe target:` (the URL the probe actually used)
- `Listening:` (what’s actually bound on the port)
- `Last gateway error:` (common root cause when the process is alive but the port isn’t listening)

### Why does sigil gateway status show Config cli and Config service different

You’re editing one config file while the service is running another (often a `--profile` / `SIGIL_STATE_DIR` mismatch).

Fix:
```bash
sigil gateway install --force
```
Run that from the same `--profile` / environment you want the service to use.

### What does another gateway instance is already listening mean

Sigil enforces a runtime lock by binding the WebSocket listener immediately on startup (default `ws://127.0.0.1:18789`). If the bind fails with `EADDRINUSE`, it throws `GatewayLockError` indicating another instance is already listening.

Fix: stop the other instance, free the port, or run with `sigil gateway --port <port>`.

### How do I run Sigil in remote mode client connects to a Gateway elsewhere
...
Notes:
- `sigil gateway` only starts when `gateway.mode` is `local` (or you pass the override flag).
...
Facts (from code):
- The Control UI stores the token in browser localStorage key `sigil.control.settings.v1`.
- The UI can import `?token=...` (and/or `?password=...`) once, then strips it from the URL.

Fix:
- Fastest: `sigil dashboard` (prints + copies tokenized link, tries to open; shows SSH hint if headless).
- If you don’t have a token yet: `sigil doctor --generate-gateway-token`.
- If remote, tunnel first: `ssh -N -L 18789:127.0.0.1:18789 user@host` then open `http://127.0.0.1:18789/?token=...`.
- Set `gateway.auth.token` (or `SIGIL_GATEWAY_TOKEN`) on the gateway host.
- In the Control UI settings, paste the same token (or refresh with a one-time `?token=...` link).
- Still stuck? Run `sigil status --all` and follow [Troubleshooting](/gateway/troubleshooting). See [Dashboard](/web/dashboard) for auth details.
...
- `SIGIL_CONFIG_PATH` (per‑instance config)
- `SIGIL_STATE_DIR` (per‑instance state)
- `agents.defaults.workspace` (workspace isolation)
- `gateway.port` (unique ports)

Quick setup (recommended):
- Use `sigil --profile <name> …` per instance (auto-creates `~/.sigil-<name>`).
- Set a unique `gateway.port` in each profile config (or pass `--port` for manual runs).
- Install a per-profile service: `sigil --profile <name> gateway install`.

Profiles also suffix service names (`com.sigil.<profile>`, `sigil-gateway-<profile>.service`, `Sigil Gateway (<profile>)`).
...
```
sigil tui --url ws://<host>:18789 --token <token>
```
...
```
/tmp/sigil/sigil-YYYY-MM-DD.log
```
...
- macOS: `$SIGIL_STATE_DIR/logs/gateway.log` and `gateway.err.log` (default: `~/.sigil/logs/...`; profiles use `~/.sigil-<profile>/logs/...`)
- Linux: `journalctl --user -u sigil-gateway[-<profile>].service -n 200 --no-pager`
- Windows: `schtasks /Query /TN "Sigil Gateway (<profile>)" /V /FO LIST`
...
If you run the gateway manually, `sigil gateway --force` can reclaim the port. See [Gateway](/gateway).

### I closed my terminal on Windows how do I restart Sigil
...
1) Is the Gateway running? `sigil gateway status`
2) Is the Gateway healthy? `sigil status`
3) Does the UI have the right token? `sigil dashboard`
...
```bash
sigil channels status
sigil channels logs --channel telegram
```
...
### ELI5 sigil gateway restart vs sigil gateway

- `sigil gateway restart`: restarts the **background service** (launchd/systemd).
- `sigil gateway`: runs the gateway **in the foreground** for this terminal session.

If you installed the service, use the gateway commands. Use `sigil gateway` when
...
Outbound attachments from the agent must include a `MEDIA:<path-or-url>` line (on its own line). See [Sigil assistant setup](/start/clawd) and [Agent send](/tools/agent-send).

CLI sending:

```bash
sigil message send --target +15555550123 --message "Here you go" --media /path/to/file.png
```
...
### Is it safe to expose Sigil to inbound DMs

Treat inbound DMs as untrusted input. Defaults are designed to reduce risk:

- Default behavior on DM‑capable channels is **pairing**:
  - Unknown senders receive a pairing code; the bot does not process their message.
  - Approve with: `sigil pairing approve <channel> <code>`
  - Pending requests are capped at **3 per channel**; check `sigil pairing list <channel>` if a code didn’t arrive.
- Opening DMs publicly requires explicit opt‑in (`dmPolicy: "open"` and allowlist `"*"`).

Run `sigil doctor` to surface risky DM policies.
...
No. Default WhatsApp DM policy is **pairing**. Unknown senders only get a pairing code and their message is **not processed**. Sigil only replies to chats it receives or to explicit sends you trigger.

Approve pairing with:

```bash
sigil pairing approve whatsapp <code>
```

List pending requests:

```bash
sigil pairing list whatsapp
```
...
Sigil blocks **cross‑provider** messaging by default. If a tool call is bound
...
**A:** In Sigil, credentials and model selection are separate. Setting `ANTHROPIC_API_KEY` (or storing an Anthropic API key in auth profiles) enables authentication, but the actual default model is whatever you configure in `agents.defaults.model.primary` (for example, `anthropic/claude-sonnet-4-5` or `anthropic/claude-opus-4-5`). If you see `No credentials found for profile "anthropic:default"`, it means the Gateway couldn’t find Anthropic credentials in the expected `auth-profiles.json` for the agent that’s running.

---

Still stuck? Ask in [Discord](https://discord.com/invite/clawd) or open a [GitHub discussion](https://github.com/sigil/sigil/discussions).
