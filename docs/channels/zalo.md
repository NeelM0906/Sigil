...
- Install via CLI: `sigil plugins install @sigil/zalo`
- Or select **Zalo** during onboarding and confirm the install prompt
- Details: [Plugins](/plugin)

## Quick setup (beginner)
1) Install the Zalo plugin:
   - From a source checkout: `sigil plugins install ./extensions/zalo`
   - From npm (if published): `sigil plugins install @sigil/zalo`
...
- Approve via:
  - `sigil pairing list zalo`
  - `sigil pairing approve zalo <CODE>`
...
- Example: `sigil message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**
- Check that the token is valid: `sigil channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `sigil logs --follow`
