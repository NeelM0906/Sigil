...
### Changes
- Version alignment with core Sigil release numbers.
...
### Highlights
- First public release of the @sigil/voice-call plugin.
...
- CLI: `sigil voicecall` commands (call/start/continue/speak/end/status/tail/expose).
