import type { ChannelOnboardingAdapter, SigilConfig, WizardPrompter } from "sigil/plugin-sdk";
...
async function noteMattermostSetup(prompter: WizardPrompter): Promise<void> {
  await prompter.note(
    [
      ...
      "Docs: https://docs.sigil.bot/channels/mattermost",
    ].join("\n"),
