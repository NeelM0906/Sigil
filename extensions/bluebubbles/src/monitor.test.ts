...
import { removeAckReactionAfterReply, shouldAckReaction } from "sigil/plugin-sdk";
...
function createMockRuntime(): PluginRuntime {
  return {
    ...
    state: {
      resolveStateDir: vi.fn(() => "/tmp/sigil") as unknown as PluginRuntime["state"]["resolveStateDir"],
    },
  };
}
