...
Nostr DM channel plugin for Sigil using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to Sigil. It enables your bot to:
...
# Configure sigil to use local relay
