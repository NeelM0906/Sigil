...
import type { SigilConfig, SkillConfig } from "../../config/config.js";
...
export function resolveConfigPath(config: SigilConfig | undefined, pathStr: string) {
...
export function isConfigPathTruthy(config: SigilConfig | undefined, pathStr: string): boolean {
...
function isBundledSkill(entry: SkillEntry): boolean {
  return entry.skill.source === "sigil-bundled";
}

export function resolveBundledAllowlist(config?: SigilConfig): string[] | undefined {
