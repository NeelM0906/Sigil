...
describe("createSigilCodingTools", () => {
  ...
  it("gates apply_patch behind tools.exec.applyPatch for OpenAI models", () => {
    ...
    const openAiTools = createSigilCodingTools({
      config,
    ...
    const anthropicTools = createSigilCodingTools({
      config,
  ...
  it("respects apply_patch allowModels", () => {
    ...
    const allowed = createSigilCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5.2",
    });
    ...
    const denied = createSigilCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
