...
function resolveAvatarSource(cfg: SigilConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: SigilConfig, agentId: string): AgentAvatarResolution {
