...
export const DEFAULT_LOG_DIR = "/tmp/sigil";
export const DEFAULT_LOG_FILE = path.join(DEFAULT_LOG_DIR, "sigil.log"); // legacy single-file path

const LOG_PREFIX = "sigil";
...
function resolveSettings(): ResolvedSettings {
  let cfg: SigilConfig["logging"] | undefined =
    (loggingState.overrideSettings as LoggerSettings | null) ?? readLoggingConfig();
  if (!cfg) {
    try {
      const loaded = requireConfig("../config/config.js") as {
        loadConfig?: () => SigilConfig;
      };
