import type { SigilConfig } from "../config/types.js";
...
export function isCommandEnabled(cfg: SigilConfig, commandKey: string): boolean {
...
function resolveDefaultCommandContext(cfg?: SigilConfig): {
  provider: string;
  model: string;
} {
...
export function getCommandDetection(_cfg?: SigilConfig): CommandDetection {
  const commands = getChatCommands();
...
export function maybeResolveTextAlias(raw: string, cfg?: SigilConfig) {
