const DEFAULT_TAGLINE = "All your chats, one Sigil.";
...
const TAGLINES: string[] = [
  "Your terminal just got magical—type something and let the bot handle the busywork.",
  ...
  "Automation with magic: minimal fuss, maximum impact.",
  ...
  "Sparks flying, commits landing—let's ship something mildly responsible.",
  "I'll streamline your workflow like magic: seamless, elegant, effective.",
  "Shell yeah—I'm here to banish the toil and leave you the glory.",
...
export function pickTagline(options: TaglineOptions = {}): string {
  ...
  const override = env?.SIGIL_TAGLINE_INDEX;
