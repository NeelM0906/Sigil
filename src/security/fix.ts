...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof SigilConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: SigilConfig; env: NodeJS.ProcessEnv }): {
  cfg: SigilConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
