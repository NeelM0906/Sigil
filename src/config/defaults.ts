...
function resolveAnthropicDefaultAuthMode(cfg: SigilConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: SigilConfig): SigilConfig {
...
export function applyTalkApiKey(config: SigilConfig): SigilConfig {
...
export function applyModelDefaults(cfg: SigilConfig): SigilConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: SigilConfig): SigilConfig {
...
export function applyLoggingDefaults(cfg: SigilConfig): SigilConfig {
...
export function applyContextPruningDefaults(cfg: SigilConfig): SigilConfig {
...
export function applyCompactionDefaults(cfg: SigilConfig): SigilConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) return cfg;
