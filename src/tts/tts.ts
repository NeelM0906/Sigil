...
export function resolveTtsConfig(cfg: SigilConfig): ResolvedTtsConfig {
...
export function resolveTtsPrefsPath(config: ResolvedTtsConfig): string {
  ...
  const envPath = process.env.SIGIL_TTS_PREFS?.trim();
...
export function buildTtsSystemPromptHint(cfg: SigilConfig): string | undefined {
