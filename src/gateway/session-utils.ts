...
import { type SigilConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: SigilConfig): string[] {
...
export function listAgentsForGateway(cfg: SigilConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: SigilConfig): string {
  return normalizeAgentId(resolveDefaultAgentId(cfg));
}

export function resolveSessionStoreKey(params: { cfg: SigilConfig; sessionKey: string }): string {
...
function resolveSessionStoreAgentId(cfg: SigilConfig, canonicalKey: string): string {
...
export function resolveGatewaySessionStoreTarget(params: { cfg: SigilConfig; key: string }): {
  agentId: string;
  storePath: string;
  canonicalKey: string;
  storeKeys: string[];
...
export function loadCombinedSessionStoreForGateway(cfg: SigilConfig): {
  storePath: string;
...
export function getSessionDefaults(cfg: SigilConfig): GatewaySessionsDefaults {
