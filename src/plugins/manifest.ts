...
export const PLUGIN_MANIFEST_FILENAME = "sigil.plugin.json";
...
// package.json "sigil" metadata (used for onboarding/catalog)
...
export type SigilPackageManifest = {
  extensions?: string[];
...
): SigilPackageManifest | undefined {
  if (!manifest) return undefined;
  return manifest.sigil ?? manifest[LEGACY_MANIFEST_KEY];
}
