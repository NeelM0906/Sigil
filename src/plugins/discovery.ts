...
function deriveIdHint(params: {
  ...
  // package is scoped (example: @sigil/voice-call -> voice-call).
...
function addCandidate(params: {
  ...
  params.candidates.push({
    ...
    packageSigil: getPackageManifestMetadata(manifest ?? undefined),
  });
}
...
export function discoverSigilPlugins(params: {
  workspaceDir?: string;
  extraPaths?: string[];
  ...
  if (workspaceDir) {
    ...
    const workspaceExt = path.join(workspaceRoot, ".sigil", "extensions");
    discoverInDirectory({
      dir: workspaceExt,
      origin: "workspace",
