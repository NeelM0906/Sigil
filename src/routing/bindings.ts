...
export function listBindings(cfg: SigilConfig): AgentBinding[] {
  return Array.isArray(cfg.bindings) ? cfg.bindings : [];
}

export function listBoundAccountIds(cfg: SigilConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: SigilConfig) {
