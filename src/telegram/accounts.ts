...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.SIGIL_DEBUG_TELEGRAM_ACCOUNTS)) {
...
export function listTelegramAccountIds(cfg: SigilConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: SigilConfig): string {
...
function mergeTelegramAccountConfig(cfg: SigilConfig, accountId: string): TelegramAccountConfig {
...
export function listEnabledTelegramAccounts(cfg: SigilConfig): ResolvedTelegramAccount[] {
