...
export const A2UI_PATH = "/__sigil__/a2ui";
export const CANVAS_HOST_PATH = "/__sigil__/canvas";
export const CANVAS_WS_PATH = "/__sigil/ws";
...
(() => {
  ...
  const handlerNames = ["sigilCanvasA2UIAction", "${legacyHandlerName}"];
  ...
  globalThis.Sigil = globalThis.Sigil ?? {};
  globalThis.Sigil.postMessage = postToNode;
  globalThis.Sigil.sendUserAction = sendUserAction;
  globalThis.sigilPostMessage = postToNode;
  globalThis.sigilSendUserAction = sendUserAction;
  globalThis.sigilPostMessage = postToNode;
  globalThis.sigilSendUserAction = sendUserAction;
