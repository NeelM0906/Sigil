...
export type ChannelAgentToolFactory = (params: { cfg?: SigilConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: SigilConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: SigilConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: SigilConfig }) => boolean;
  supportsCards?: (params: { cfg: SigilConfig }) => boolean;
