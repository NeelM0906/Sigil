...
export function applyZaiConfig(cfg: SigilConfig): SigilConfig {
...
export function applyOpenrouterProviderConfig(cfg: SigilConfig): SigilConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayProviderConfig(cfg: SigilConfig): SigilConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayConfig(cfg: SigilConfig): SigilConfig {
...
export function applyOpenrouterConfig(cfg: SigilConfig): SigilConfig {
...
export function applyMoonshotProviderConfig(cfg: SigilConfig): SigilConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyMoonshotConfig(cfg: SigilConfig): SigilConfig {
...
export function applyKimiCodeProviderConfig(cfg: SigilConfig): SigilConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: SigilConfig): SigilConfig {
...
export function applySyntheticProviderConfig(cfg: SigilConfig): SigilConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: SigilConfig): SigilConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: SigilConfig): SigilConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: SigilConfig): SigilConfig {
