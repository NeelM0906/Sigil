...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.sigil.bot/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("sigil hooks list")}`,
      `  ${formatCliCommand("sigil hooks enable <name>")}`,
      `  ${formatCliCommand("sigil hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
