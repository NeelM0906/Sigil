...
async function withTempHome<T>(fn: (home: string) => Promise<T>): Promise<T> {
  return withTempHomeBase(fn, { prefix: "sigil-agent-" });
}

function mockConfig(
  home: string,
  storePath: string,
  agentOverrides?: Partial<NonNullable<NonNullable<SigilConfig["agents"]>["defaults"]>>,
  telegramOverrides?: Partial<NonNullable<SigilConfig["telegram"]>>,
