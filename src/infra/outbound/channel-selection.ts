...
async function isPluginConfigured(plugin: ChannelPlugin, cfg: SigilConfig): Promise<boolean> {
...
export async function listConfiguredMessageChannels(cfg: SigilConfig): Promise<MessageChannelId[]> {
