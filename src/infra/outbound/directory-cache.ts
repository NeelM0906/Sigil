...
export class DirectoryCache<T> {
  ...
  private lastConfigRef: SigilConfig | null = null;

  constructor(private readonly ttlMs: number) {}

  get(key: string, cfg: SigilConfig): T | undefined {
  ...
  set(key: string, value: T, cfg: SigilConfig): void {
    this.resetIfConfigChanged(cfg);
  ...
  clear(cfg?: SigilConfig): void {
    this.cache.clear();
    if (cfg) this.lastConfigRef = cfg;
  }

  private resetIfConfigChanged(cfg: SigilConfig): void {
