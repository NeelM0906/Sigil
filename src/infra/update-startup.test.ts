...
describe("update-startup", () => {
  ...
  beforeEach(async () => {
    ...
    tempDir = await fs.mkdtemp(path.join(os.tmpdir(), "sigil-update-check-"));
  ...
  it("logs update hint for npm installs when newer tag exists", async () => {
    const { resolveSigilPackageRoot } = await import("./sigil-root.js");
    ...
    vi.mocked(resolveSigilPackageRoot).mockResolvedValue("/opt/sigil");
