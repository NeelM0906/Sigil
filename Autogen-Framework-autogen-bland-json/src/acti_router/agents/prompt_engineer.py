...
async def run(user_request: str, stratum: str, tools, pattern_hints, model: str = "gpt-4o-mini"):
    payload = {"user_request": user_request, "stratum": stratum, "tools": tools, "pattern_hints": pattern_hints}
    return await _run(PROMPT_ENGINEER_SYSTEM, payload, model)
