...
# Output:
# - dist/Sigil.app
# - dist/Sigil-<version>.zip
# - dist/Sigil-<version>.dmg
...
ZIP="$ROOT_DIR/dist/Sigil-$VERSION.zip"
DMG="$ROOT_DIR/dist/Sigil-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/Sigil-$VERSION.notary.zip"
