...
final class ScreenController {
    ...
    /// Callback invoked when a sigil:// deep link is tapped in the canvas
    ...
    private static func bundledResourceURL(
        ...
        -> URL?
    {
        let bundle = SigilKitResources.bundle
...
/// Handles navigation policy to intercept sigil:// deep links from canvas
@MainActor
