...
final class LocationService: NSObject, CLLocationManagerDelegate {
    ...
    func ensureAuthorization(mode: SigilLocationMode) async -> CLAuthorizationStatus {
    ...
    private static func accuracyValue(_ accuracy: SigilLocationAccuracy) -> CLLocationAccuracy {
        switch accuracy {
        case .coarse:
