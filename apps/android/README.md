## Sigil Node (Android) (internal)

Modern Android node app: connects to the **Gateway WebSocket** (`_sigil-gw._tcp`) and exposes **Canvas + Chat + Camera**.
...
```bash
pnpm sigil gateway --port 18789 --verbose
```
