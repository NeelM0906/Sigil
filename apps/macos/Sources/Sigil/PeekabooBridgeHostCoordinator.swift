...
final class PeekabooBridgeHostCoordinator {
    ...
    private let logger = Logger(subsystem: "com.sigil", category: "PeekabooBridge")

    private var host: PeekabooBridgeHost?
    private var services: SigilPeekabooBridgeServices?
    ...
    private func startIfNeeded() async {
        ...
        let services = SigilPeekabooBridgeServices()
        ...
        let host = PeekabooBridgeHost(
            socketPath: PeekabooBridgeConstants.sigilSocketPath,
            server: server,
        ...
        await host.start()
        self.logger
            .info("PeekabooBridge host started at \(PeekabooBridgeConstants.sigilSocketPath, privacy: .public)")
    }
...
@MainActor
private final class SigilPeekabooBridgeServices: PeekabooBridgeServiceProviding {
    ...
    init() {
        let logging = LoggingService(subsystem: "com.sigil.peekaboo")
