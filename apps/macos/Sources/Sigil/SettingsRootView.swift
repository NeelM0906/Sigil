...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .sigilSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? SigilPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? SigilPaths.stateDirURL.path
...
extension Notification.Name {
    static let sigilSelectSettingsTab = Notification.Name("sigilSelectSettingsTab")
}
