...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "com.sigil", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".sigil/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.sigilCommand(
            subcommand: "gateway",
