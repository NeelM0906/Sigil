...
enum UIStrings {
    static let welcomeTitle = "Welcome to Sigil"
}
...
struct OnboardingView: View {
    ...
    @State var anthropicAuthDetectedStatus: SigilOAuthStore.AnthropicOAuthStatus = .missingFile
    ...
    @State var onboardingChatModel: SigilChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g sigil@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: SigilChatViewModel(
