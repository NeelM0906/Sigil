...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "com.sigil", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "com.sigil", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [SigilChatMessage] = messages.compactMap { item in
