...
enum SigilConfigFile {
    private static let logger = Logger(subsystem: "com.sigil", category: "config")

    static func url() -> URL {
        SigilPaths.configURL
    }

    static func stateDirURL() -> URL {
        SigilPaths.stateDirURL
    }

    static func defaultWorkspaceURL() -> URL {
        SigilPaths.workspaceURL
    }
