...
enum ExecApprovalsStore {
    private static let logger = Logger(subsystem: "com.sigil", category: "exec-approvals")
    ...
    static func fileURL() -> URL {
        SigilPaths.stateDirURL.appendingPathComponent("exec-approvals.json")
    }

    static func socketPath() -> String {
        SigilPaths.stateDirURL.appendingPathComponent("exec-approvals.sock").path
    }
