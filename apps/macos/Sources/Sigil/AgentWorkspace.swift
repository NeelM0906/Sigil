...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "com.sigil", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return SigilConfigFile.defaultWorkspaceURL() }
