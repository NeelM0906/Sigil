...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "com.sigil", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other Sigil windows, but below the system’s pop-up menus.
