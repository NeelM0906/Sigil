...
@MainActor
public struct SigilChatView: View {
    public enum Style {
        case standard
        case onboarding
    }

    @State private var viewModel: SigilChatViewModel
    ...
    private var visibleMessages: [SigilChatMessage] {
        let base: [SigilChatMessage]
    ...
    private func mergeToolResults(in messages: [SigilChatMessage]) -> [SigilChatMessage] {
    ...
    private func isToolResultMessage(_ message: SigilChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: SigilChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: SigilChatMessage) -> String {
