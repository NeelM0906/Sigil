...
public typealias SigilPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias SigilPlatformImage = UIImage
#endif

public struct SigilChatUsageCost: Codable, Hashable, Sendable {
...
public struct SigilChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: SigilChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(SigilChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct SigilChatMessageContent: Codable, Hashable, Sendable {
...
public struct SigilChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [SigilChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: SigilChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [SigilChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: SigilChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(SigilChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([SigilChatMessageContent].self, forKey: .content) {
...
public struct SigilChatHistoryPayload: Codable, Sendable {
...
public struct SigilSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct SigilSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [SigilSessionPreviewItem]
}

public struct SigilSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [SigilSessionPreviewEntry]

    public init(ts: Int, previews: [SigilSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct SigilChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct SigilChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct SigilAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct SigilChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct SigilGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct SigilPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: SigilPlatformImage?
...
public struct SigilChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
