...
public enum SigilCanvasA2UICommand: String, Codable, Sendable {
...
public struct SigilCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct SigilCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
