...
class MoltbotA2UIHost extends LitElement {
  ...
  #handleA2UIAction(evt) {
    ...
    const handler =
      ...
      globalThis.webkit?.messageHandlers?.sigilCanvasA2UIAction ??
      globalThis.moltbotCanvasA2UIAction ??
      globalThis.sigilCanvasA2UIAction;
    if (handler?.postMessage) {
      try {
        ...
        if (
          ...
          handler === globalThis.sigilCanvasA2UIAction
        ) {
